...
const pages = ['Home', 'Travel Agency'];
          ...
          <Box sx={{  display: { xs: 'none', md: 'flex' },marginLeft:'auto' }}>
            {pages.map((page) => (
              <Button
                key={page}
                onClick={()=>{
                  page=="Travel Agency"? navigate("/dTravelAgency"):(page=="Drivers"?navigate("/drivers"):navigate("/"))
                }}
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={()=>{
                  setting=="Manage Account"?navigate("/DriverProfile"):handleCloseUserMenu()
                }}>
