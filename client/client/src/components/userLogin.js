...
const handleChange=(e)=>{
  ...
  style={{ minHeight: '100vh' }}
   ...
   <form onSubmit={handleSubmit}>
       ...
       <p >A 4 digit OTP will be send on SMS</p>
       </Grid>
       ...
       <input type="number" value={number} name="phoneNo" onChange={handleChange} style={textFStyle}></input>
      ...
      }} className='button' onClick={()=>navigate("/otp")} >Next </Button>
