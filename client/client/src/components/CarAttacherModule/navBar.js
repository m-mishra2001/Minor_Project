            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={()=>{
                  page=="Travel Agency"? navigate("/ctravelAgency"):(page=="Drivers"?navigate("/drivers"):navigate("/"))
                }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={()=>{
                  setting=="Manage Account"?navigate("/carAttacherProfile"):handleCloseUserMenu()
                }}>
